...
# The code is only outputting the March balance calculation because that is the last iteration. We need to sum all of the iterations (months). Add counter (=+) to fix.