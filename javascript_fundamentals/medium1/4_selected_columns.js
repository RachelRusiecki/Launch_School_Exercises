...
// The problem is that the length variables in the for loops are declared w/ var which has function scope, not block scope. So length is always getting reassigned to the length of the columns when it should be the length of the array argument for th outer loop
